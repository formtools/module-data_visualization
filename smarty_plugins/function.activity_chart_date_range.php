...
function smarty_function_activity_chart_date_range($params, &$smarty)
{
    global $L, $LANG;
    ...
    $lines[] = "<option value=\"everything\" " . (($default == "everything") ? "selected" : "") . ">{$LANG["phrase_all_submissions"]}</option>";
