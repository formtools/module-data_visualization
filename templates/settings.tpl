    ...
    <tr>
      ...
      <td class="pad_left_small">
        ...
        <tr>
          ...
          <td><input type="text" name="quicklinks_dialog_width" id="width" size="3" value="{$module_settings.quicklinks_dialog_width}" />px</td>
        </tr>
        <tr>
          <td class="medium_grey"><label for="height">{$L.word_height}</label></td>
          <td><input type="text" name="quicklinks_dialog_height" id="height" size="3" value="{$module_settings.quicklinks_dialog_height}" />px</td>
        </tr>
        </table>
      </td>
    </tr>
