            ...
            <tr>
                <td valign="top">
                    ...
                    <tr>
                      ...
                      <td>
                      {activity_chart_date_range name_id="date_range" default=$module_settings.activity_chart_date_range}
                      </td>
                    </tr>
                    <tr>
                      <td class="pad_left_small">Group submission count by</td>
                      <td >
                        <input type="radio" name="submission_count_group" id="scd1" value="month" {if $module_settings.activity_chart_submission_count_group == "month"}checked{/if} />
                          <label for="scd1">{$L.word_month}</label>
                        <input type="radio" name="submission_count_group" id="scd3" value="day" {if $module_settings.activity_chart_submission_count_group == "day"}checked{/if} />
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="radio" name="chart_type" id="lc1" value="line_chart" {if $module_settings.activity_chart_default_chart_type == "line_chart"}checked{/if} />
                          <label for="lc1">{$L.phrase_line_chart}</label>
                        <input type="radio" name="chart_type" id="lc2" value="area_chart" {if $module_settings.activity_chart_default_chart_type == "area_chart"}checked{/if} />
                          <label for="lc2">{$L.phrase_area_chart}</label>
                      <input type="radio" name="chart_type" id="lc3" value="column_chart" {if $module_settings.activity_chart_default_chart_type == "column_chart"}checked{/if} />
